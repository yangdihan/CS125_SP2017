...
void testReverse()
{
    ...
    cout << "[testReverse]: " << list1 << endl;

    cout << "[testReverse]: size: " << list1.size() << endl;
    // before this is the list I am trying to add to test reverse by using an integer list
...
void testReverseNth()
{
    ...
    cout << "[testReverseNth]: " << list1 << endl;

    cout << "[testReverseNth]: size: " << list1.size() << endl;
...
void testWaterfall()
{
    ...
    cout << "[testWaterfall]: " << list1 << endl;

    cout << "[testWaterfall]: size: " << list1.size() << endl;
...
void testSplit()
{
    ...
    for (size_t i = 1; i <= 10; i++)
        listA.insertFront(i);
    List<int> listB = listA.split(6);
    cout << "[testSplit]: Previous list" << listA << endl;

    cout << "[testSplit]: Previous list size: " << listA.size() << endl;

    cout << "[testSplit]: Second list" << listB << endl;

    cout << "[testSplit]: Second list size: " << listB.size() << endl;
...
void testMerge()
{
    ...
    listA.mergeWith(listB);

    cout << "[testMerge]: Merged list" << listA << endl;

    cout << "[testMerge]: Merged size: " << listA.size() << endl;

    cout << "Test if listB is NULL" << listB << endl;
...
void testSort()
{
    ...
    cout << "[testSort]: Unsorted list" << listA << endl;
    listA.sort();

    cout << "[testSort]: Sorted list" << listA << endl;

    cout << "[testSort]: Sorted size: " << listA.size() << endl;
