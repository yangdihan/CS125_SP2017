...
public class LinkedListTest extends TestCase {
	...
	public void testGetLongestWord() {
		...
		//System.out.println(longWord.getLongestWord());
...
//		System.out.println(head.toString());
	...
	public void testGetReversedSentence() {
		...
		//System.out.println(head.getSentence());
		//System.out.println(tail.getReversedSentence(""));
		//System.out.println(head.getReversedSentence(""));
	...
	public void testCreateLinkedList() {
		...
		//System.out.println(list.getSentence());
	...
	public void testFindLast() {
		...
		//System.out.println(head.findLast("one"));
	...
	public void testInsertInCorrectPosition() {
		...
		assertTrue(head == originalHead); // expect no change
		head = head.insert("A");
		assertTrue(head != originalHead); // expect change
		//System.out.println(head.getSentence());
